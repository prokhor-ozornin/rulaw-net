  ...
  public sealed class TranscriptMeetingQuestionTests : UnitTestsBase<TranscriptMeetingQuestion>
  {
    ...
    public void Json()
    {
      ...
      this.TestJson(
        ...
        {
          Name = "name",
          Parts = new List<TranscriptMeetingQuestionPart> { new TranscriptMeetingQuestionPart() },
          Stage = "stage"
        },
    ...
    /// <summary>
    ///   <para>Performs testing of <see cref="TranscriptMeetingQuestion.CompareTo(TranscriptMeetingQuestion)"/> method.</para>
    /// </summary>
    [Fact]
    ...
    ///   <list type="bullet">
    ///     <item><description><see cref="TranscriptMeetingQuestion.Equals(TranscriptMeetingQuestion)"/></description></item>
