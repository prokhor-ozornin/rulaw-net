...
namespace RuLaw
{
  ...
  public sealed class DeputyRequestSignerTests : UnitTestsBase<DeputyRequestSigner>
  {
    ...
    /// <summary>
    ///   <para>Performs testing of <see cref="DeputyRequestSigner.CompareTo(DeputyRequestSigner)"/> method.</para>
    /// </summary>
    [Fact]
    ...
    ///   <list type="bullet">
    ///     <item><description><see cref="DeputyRequestSigner.Equals(DeputyRequestSigner)"/></description></item>
