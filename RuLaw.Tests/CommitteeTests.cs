...
namespace RuLaw
{
  ...
  public sealed class CommitteeTests : UnitTestsBase<Committee>
  {
    ...
    {
      this.TestDescription("Id", "Name", "Active", "FromDate", "ToDate");
    }
    ...
    /// <summary>
    ///   <para>Performs testing of <see cref="Committee.To"/> property.</para>
    /// </summary>
    [Fact]
    ...
    /// <summary>
    ///   <para>Performs testing of <see cref="Committee.CompareTo(Committee)"/> method.</para>
    /// </summary>
    [Fact]
    ...
    ///   <list type="bullet">
    ///     <item><description><see cref="Committee.Equals(Committee)"/></description></item>
