...
namespace RuLaw
{
  ...
  public sealed class FederalAuthorityTests : UnitTestsBase<FederalAuthority>
  {
    ...
    /// <summary>
    ///   <para>Performs testing of <see cref="FederalAuthority.CompareTo(FederalAuthority)"/> method.</para>
    /// </summary>
    [Fact]
    ...
    ///   <list type="bullet">
    ///     <item><description><see cref="FederalAuthority.Equals(FederalAuthority)"/></description></item>
