...
namespace RuLaw
{
  ...
  public static class DeputyInfoExtensions
  {
    ...
    public static IEnumerable<IDeputyInfo> BirthDate(this IEnumerable<IDeputyInfo> deputies, DateTime? from = null, DateTime? to = null)
    {
    ...
    public static IEnumerable<IDeputyInfo> Degree(this IEnumerable<IDeputyInfo> deputies, string degree)
    {
      Assertion.NotNull(deputies);
    ...
    public static IEnumerable<IDeputyInfo> Faction(this IEnumerable<IDeputyInfo> deputies, string faction)
    {
      Assertion.NotNull(deputies);
    ...
    public static IEnumerable<IDeputyInfo> FullName(this IEnumerable<IDeputyInfo> deputies, string name)
    {
      Assertion.NotNull(deputies);
    ...
    public static IEnumerable<IDeputyInfo> Rank(this IEnumerable<IDeputyInfo> deputies, string rank)
    {
      Assertion.NotNull(deputies);
    ...
    public static IEnumerable<IDeputyInfo> Region(this IEnumerable<IDeputyInfo> deputies, string region)
    {
      Assertion.NotNull(deputies);
    ...
    /// <exception cref="ArgumentNullException">If <paramref name="deputies"/> is a <c>null</c> reference.</exception>
    public static IEnumerable<IDeputyInfo> WorkDate(this IEnumerable<IDeputyInfo> deputies, DateTime? from = null, DateTime? to = null)
    {
      Assertion.NotNull(deputies);
