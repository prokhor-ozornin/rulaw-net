...
namespace RuLaw
{
  ...
  public static class VoteExtensions
  {
    ...
    public static IEnumerable<IVote> Subject(this IEnumerable<IVote> votes, string subject)
    {
    ...
    public static IEnumerable<IVote> Successful(this IEnumerable<IVote> votes)
    {
      Assertion.NotNull(votes);
    ...
    /// <exception cref="ArgumentNullException">If <paramref name="votes"/> is a <c>null</c> reference.</exception>
    public static IEnumerable<IVote> Unsuccessful(this IEnumerable<IVote> votes)
    {
      Assertion.NotNull(votes);
