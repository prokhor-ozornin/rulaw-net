...
namespace RuLaw
{
  ...
  public static class IApiCallerExtensions
  {
    ...
    public static IEnumerable<ILawBranch> Branches(this IApiCaller caller)
    {
      ...
      return caller.Call<List<LawBranch>>("/{0}/classes".FormatSelf(caller.ApiToken)).Data.Cast<ILawBranch>();
    }
    ...
    public static IEnumerable<ICommittee> Committees(this IApiCaller caller)
    {
      ...
      return caller.Call<List<Committee>>("/{0}/committees".FormatSelf(caller.ApiToken)).Data.Cast<ICommittee>();
    }
    ...
    public static IEnumerable<IDeputy> Deputies(this IApiCaller caller, Action<IDeputiesLawApiCall> call = null)
    {
      ...
      return caller.Call<List<Deputy>>("/{0}/deputies".FormatSelf(caller.ApiToken), parameters).Data.Cast<IDeputy>();
    }
    ...
    public static IEnumerable<IAuthority> FederalAuthorities(this IApiCaller caller, Action<IAuthoritiesLawApiCall> call = null)
    {
      ...
      return caller.Call<List<FederalAuthority>>("/{0}/federal-organs".FormatSelf(caller.ApiToken), parameters).Data.Cast<IAuthority>();
    }
    ...
    public static IEnumerable<IInstance> Instances(this IApiCaller caller, Action<IInstancesLawApiCall> call = null)
    {
      ...
      return caller.Call<List<Instance>>("/{0}/instances".FormatSelf(caller.ApiToken), parameters).Data.Cast<IInstance>();
    }
    ...
    public static IEnumerable<IConvocation> Convocations(this IApiCaller caller)
    {
      ...
      return caller.Call<List<Convocation>>("/{0}/periods".FormatSelf(caller.ApiToken)).Data.Cast<IConvocation>();
    }
    ...
    public static IEnumerable<IAuthority> RegionalAuthorities(this IApiCaller caller, Action<IAuthoritiesLawApiCall> call = null)
    {
      ...
      return caller.Call<List<RegionalAuthority>>("/{0}/regional-organs".FormatSelf(caller.ApiToken), parameters).Data.Cast<IAuthority>();
    }
    ...
    public static IEnumerable<IDeputyRequest> Requests(this IApiCaller caller)
    {
      ...
      return caller.Call<List<DeputyRequest>>("/{0}/requests".FormatSelf(caller.ApiToken)).Data.Cast<IDeputyRequest>();
    }
    ...
    public static IEnumerable<IPhaseStage> Stages(this IApiCaller caller)
    {
      ...
      return caller.Call<List<PhaseStage>>("/{0}/stages".FormatSelf(caller.ApiToken)).Data.Cast<IPhaseStage>();
    }
    ...
    public static IEnumerable<ITopic> Topics(this IApiCaller caller)
    {
      ...
      return caller.Call<List<Topic>>("/{0}/topics".FormatSelf(caller.ApiToken)).Data.Cast<ITopic>();
    }
