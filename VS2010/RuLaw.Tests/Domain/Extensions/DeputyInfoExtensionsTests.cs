...
namespace RuLaw
{
  ...
  {
    /// <summary>
    ///   <para>Performs testing of <see cref="DeputyInfoExtensions.BirthDate(IEnumerable{IDeputyInfo}, DateTime?, DateTime?)"/> method.</para>
    /// </summary>
    [Fact]
    ...
    /// <summary>
    ///   <para>Performs testing of <see cref="DeputyInfoExtensions.Degree(IEnumerable{IDeputyInfo}, string)"/> method.</para>
    /// </summary>
    [Fact]
    ...
    /// <summary>
    ///   <para>Performs testing of <see cref="DeputyInfoExtensions.Faction(IEnumerable{IDeputyInfo}, string)"/> method.</para>
    /// </summary>
    [Fact]
    ...
    /// <summary>
    ///   <para>Performs testing of <see cref="DeputyInfoExtensions.FullName(IEnumerable{IDeputyInfo}, string)"/> method.</para>
    /// </summary>
    [Fact]
    public void FullName_Method()
    {
      Assert.Throws<ArgumentNullException>(() => DeputyInfoExtensions.FullName(null, "name"));
    ...
    /// <summary>
    ///   <para>Performs testing of <see cref="DeputyInfoExtensions.Rank(IEnumerable{IDeputyInfo}, string)"/> method.</para>
    /// </summary>
    [Fact]
    ...
    /// <summary>
    ///   <para>Performs testing of <see cref="DeputyInfoExtensions.Region(IEnumerable{IDeputyInfo}, string)"/> method.</para>
    /// </summary>
    [Fact]
    public void Region_Method()
    {
      ...
      Assert.False(Enumerable.Empty<IDeputyInfo>().Region("region").Any());
    ...
    /// <summary>
    ///   <para>Performs testing of <see cref="DeputyInfoExtensions.WorkDate(IEnumerable{IDeputyInfo}, DateTime?, DateTime?)"/> method.</para>
    /// </summary>
    [Fact]
