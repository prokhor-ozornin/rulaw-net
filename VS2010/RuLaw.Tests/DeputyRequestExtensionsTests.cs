...
namespace RuLaw
{
  ...
  {
    /// <summary>
    ///   <para>Performs testing of <see cref="DeputyRequestExtensions.Answer(IEnumerable{DeputyRequest}, string)"/> method.</para>
    /// </summary>
    [Fact]
    public void Answer_Method()
    {
      Assert.Throws<ArgumentNullException>(() => DeputyRequestExtensions.Answer(null, "text"));
      Assert.Throws<ArgumentNullException>(() => Enumerable.Empty<DeputyRequest>().Answer(null));
      Assert.Throws<ArgumentException>(() => Enumerable.Empty<DeputyRequest>().Answer(string.Empty));

      Assert.False(Enumerable.Empty<DeputyRequest>().Answer("answer").Any());
    ...
    /// <summary>
    ///   <para>Performs testing of <see cref="DeputyRequestExtensions.ControlDate(IEnumerable{DeputyRequest}, DateTime?, DateTime?)"/> method.</para>
    /// </summary>
    [Fact]
    public void ControlDate_Method()
    {
      ...
      Assert.False(Enumerable.Empty<DeputyRequest>().ControlDate().Any());
    ...
    /// <summary>
    ///   <para>Performs testing of <see cref="DeputyRequestExtensions.Initiator(IEnumerable{DeputyRequest}, string)"/> method.</para>
    /// </summary>
    [Fact]
    public void Initiator_Method()
    {
      Assert.Throws<ArgumentNullException>(() => DeputyRequestExtensions.Initiator(null, "initiator"));
      Assert.Throws<ArgumentNullException>(() => Enumerable.Empty<DeputyRequest>().Initiator(null));
      Assert.Throws<ArgumentException>(() => Enumerable.Empty<DeputyRequest>().Initiator(string.Empty));

      Assert.False(Enumerable.Empty<DeputyRequest>().Initiator("initiator").Any());
    ...
    /// <summary>
    ///   <para>Performs testing of <see cref="DeputyRequestExtensions.SignDate(IEnumerable{DeputyRequest}, DateTime?, DateTime?)"/> method.</para>
    /// </summary>
    [Fact]
