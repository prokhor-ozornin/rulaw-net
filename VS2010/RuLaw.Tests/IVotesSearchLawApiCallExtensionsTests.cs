...
namespace RuLaw
{
  ...
  {
    /// <summary>
    ///   <para>Performs testing of <see cref="IVotesSearchLawApiCallExtensions.Convocation(IVotesSearchLawApiCall, Convocation)"/> method.</para>
    /// </summary>
    [Fact]
    ...
    /// <summary>
    ///   <para>Performs testing of <see cref="IVotesSearchLawApiCallExtensions.Deputy(IVotesSearchLawApiCall, Deputy)"/> method.</para>
    /// </summary>
    [Fact]
