...
namespace RuLaw
{
  ...
  public sealed class TranscriptVoteTests : UnitTestsBase<TranscriptVote>
  {
    ...
    /// <summary>
    ///   <para>Performs testing of <see cref="TranscriptVote.CompareTo(TranscriptVote)"/> method.</para>
    /// </summary>
    [Fact]
    ...
    ///   <list type="bullet">
    ///     <item><description><see cref="TranscriptVote.Equals(TranscriptVote)"/></description></item>
