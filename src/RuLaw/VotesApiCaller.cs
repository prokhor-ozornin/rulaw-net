...
namespace RuLaw
{
    ...
    internal sealed class VotesApiCaller : IVotesApiCaller
  {
    ...
    {
      return this.caller.Call<VotesSearchResult>(string.Format(CultureInfo.InvariantCulture, "/{0}/voteSearch", this.caller.ApiToken), new Dictionary<string, object> { { "convocation", convocation }, { "from", from != null ? from.Value.RuLawDate() : null }, { "to", to != null ? to.Value.RuLawDate() : null }, { "faction", faction }, { "deputy", deputy }, { "number", number }, { "keywords", keywords }, { "page", page }, { "limit", (int?) limit }, { "sort", sorting != null ? sorting.Value.String() : null } }).Data;
    }
  }
}