...
public static class IEducationExtensions
{
  ...
  public static IEnumerable<TEntity> Institution<TEntity>(this IEnumerable<TEntity> educations, string institution) where TEntity : IEducation => educations.Where(education => education != null && education.Institution.ToLowerInvariant().Contains(institution.ToLowerInvariant()));
