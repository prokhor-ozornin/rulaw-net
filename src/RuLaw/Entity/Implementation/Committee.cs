...
public sealed class Committee : ICommittee
{
  ...
  /// </summary>
  /// <param name="info"></param>
  public Committee(object info) : this(new Info().SetState(info)) {}
  ...
  public sealed record Info : IResultable<ICommittee>
  {
    /// <summary>
    ///   <para>Unique identifier of entity.</para>
    /// </summary>
    ...
    /// </summary>
    /// <returns></returns>
    public ICommittee ToResult() => new Committee(this);
  }
}