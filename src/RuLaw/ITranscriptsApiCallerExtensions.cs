namespace RuLaw
{
  ...
  public static class ITranscriptsApiCallerExtensions
  {
    ...
    public static IDeputyTranscriptsResult Deputy(this ITranscriptsApiCaller caller, Action<IDeputyTranscriptLawApiCall> call)
    {
      ...
      return caller.Api.Call<DeputyTranscriptsResult>(string.Format(CultureInfo.InvariantCulture, "/{0}/transcriptDeputy/{1}", caller.Api.ApiToken, deputy), api.Parameters).Data;
    }
