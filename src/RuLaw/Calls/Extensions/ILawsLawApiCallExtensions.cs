namespace RuLaw
{
  ...
  public static class ILawsLawApiCallExtensions
  {
    ...
    public static ILawsLawApiCall Deputy(this ILawsLawApiCall call, IDeputy deputy)
    {
      Assertion.NotNull(call);
    ...
    public static ILawsLawApiCall ProfileCommittee(this ILawsLawApiCall call, ICommittee committee)
    {
      Assertion.NotNull(call);
    ...
    /// <returns>Back reference to the provided <paramref name="call"/> instance.</returns>
    /// <exception cref="ArgumentNullException">If either <paramref name="call"/> or <paramref name="authority"/> is a <c>null</c> reference.</exception>
    public static ILawsLawApiCall RegionalAuthority(this ILawsLawApiCall call, IAuthority authority)
    {
      Assertion.NotNull(call);
      Assertion.NotNull(authority);
    ...
    public static ILawsLawApiCall Topic(this ILawsLawApiCall call, ITopic topic)
    {
      Assertion.NotNull(call);
