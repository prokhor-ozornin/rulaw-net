...
namespace RuLaw
{
  ...
  public sealed class CommitteeTests : UnitTestsBase<Committee>
  {
    ...
    public void Json()
    {
      TestJson(new Committee(), new { id = 0, isCurrent = false, startDate = default(DateTime) });
      TestJson(
        new Committee
        {
          Id = 1,
    ...
    public void Xml()
    {
      TestXml(new Committee(), "committee", new { id = 0, isCurrent = false, startDate = default(DateTime).ISO8601() });
      TestXml(
        new Committee
        {
          Id = 1,
