...
/// </summary>
/// <seealso cref="ITranscriptsApiExtensions"/>
public sealed class ITranscriptsApiExtensionsTest : IntegrationTest
{
  ...
  public void DeputyAsync_Method()
  {
    using (new AssertionScope())
    {
      ...
      AssertionExtensions.Should(() => Api.Transcripts.DeputyAsync(_ => { }, Fixture<CancellationToken>.Create())).ThrowExactlyAsync<TaskCanceledException>().Await();
