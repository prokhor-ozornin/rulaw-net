...
public sealed class ApiTest : UnitTest
{
  ...
  public void BranchesApi_AllAsync_Method()
  {
    ...
    {
      AssertionExtensions.Should(() => Api.Branches.AllAsync(Attributes.CancellationToken()).ToListAsync()).ThrowExactlyAsync<OperationCanceledException>();
  ...
  public void CommitteesApi_AllAsync_Method()
  {
    using (new AssertionScope())
    {
      AssertionExtensions.Should(() => Api.Committees.AllAsync(Attributes.CancellationToken()).ToListAsync()).ThrowExactlyAsync<OperationCanceledException>().Await();
  ...
  public void DeputiesApi_FindAsync_Method()
  {
    using (new AssertionScope())
    {
      AssertionExtensions.Should(() => Api.Deputies.FindAsync(0, Attributes.CancellationToken())).ThrowExactlyAsync<OperationCanceledException>().Await();
  ...
  public void DeputiesApi_SearchAsync_Method()
  {
    using (new AssertionScope())
    {
      AssertionExtensions.Should(() => Api.Deputies.SearchAsync(null, Attributes.CancellationToken()).ToListAsync()).ThrowExactlyAsync<OperationCanceledException>().Await();
  ...
  public void AuthoritiesApi_FederalAsync_Method()
  {
    using (new AssertionScope())
    {
      AssertionExtensions.Should(() => Api.Authorities.FederalAsync(null, Attributes.CancellationToken()).ToListAsync()).ThrowExactlyAsync<OperationCanceledException>().Await();
  ...
  public void AuthoritiesApi_RegionalAsync_Method()
  {
    using (new AssertionScope())
    {
      AssertionExtensions.Should(() => Api.Authorities.RegionalAsync(null, Attributes.CancellationToken()).ToListAsync()).ThrowExactlyAsync<OperationCanceledException>().Await();
  ...
  public void InstancesApi_SearchAsync_Method()
  {
    using (new AssertionScope())
    {
      AssertionExtensions.Should(() => Api.Instances.SearchAsync(null, Attributes.CancellationToken()).ToListAsync()).ThrowExactlyAsync<OperationCanceledException>().Await();
  ...
  public void LawsApi_SearchAsync_Method()
  {
    using (new AssertionScope())
    {
      ...
      AssertionExtensions.Should(() => Api.Laws.SearchAsync(new LawsApiRequest(), Attributes.CancellationToken())).ThrowExactlyAsync<OperationCanceledException>().Await();
  ...
  public void ConvocationsApi_AllAsync_Method()
  {
    using (new AssertionScope())
    {
      AssertionExtensions.Should(() => Api.Convocations.AllAsync(Attributes.CancellationToken()).ToListAsync()).ThrowExactlyAsync<OperationCanceledException>().Await();
  ...
  public void QuestionsApi_SearchAsync_Method()
  {
    using (new AssertionScope())
    {
      AssertionExtensions.Should(() => Api.Questions.SearchAsync(null, Attributes.CancellationToken()).Await()).ThrowExactly<OperationCanceledException>();
  ...
  public void StagesApi_AllAsync_Method()
  {
    using (new AssertionScope())
    {
      AssertionExtensions.Should(() => Api.Stages.AllAsync(Attributes.CancellationToken()).ToListAsync()).ThrowExactlyAsync<OperationCanceledException>();
  ...
  public void TopicsApi_AllAsync_Method()
  {
    using (new AssertionScope())
    {
      AssertionExtensions.Should(() => Api.Topics.AllAsync(Attributes.CancellationToken()).ToListAsync()).ThrowExactlyAsync<OperationCanceledException>();
  ...
  public void TranscriptsApi_DeputyAsync_Method()
  {
    using (new AssertionScope())
    {
      ...
      AssertionExtensions.Should(() => Api.Transcripts.DeputyAsync(new DeputyTranscriptApiRequest(), Attributes.CancellationToken())).ThrowExactlyAsync<OperationCanceledException>().Await();
  ...
  public void TranscriptsApi_LawAsync_Method()
  {
    using (new AssertionScope())
    {
      ...
      AssertionExtensions.Should(() => Api.Transcripts.LawAsync(Attributes.Random().Letters(25), Attributes.CancellationToken())).ThrowExactlyAsync<OperationCanceledException>().Await();
  ...
  public void TranscriptsApi_QuestionAsync_Method()
  {
    using (new AssertionScope())
    {
      AssertionExtensions.Should(() => Api.Transcripts.QuestionAsync(0, 0, Attributes.CancellationToken())).ThrowExactlyAsync<OperationCanceledException>().Await();
  ...
  public void TranscriptsApi_ResolutionAsync_Method()
  {
    using (new AssertionScope())
    {
      ...
      AssertionExtensions.Should(() => Api.Transcripts.ResolutionAsync(Attributes.Random().Letters(25), Attributes.CancellationToken())).ThrowExactlyAsync<OperationCanceledException>().Await();
