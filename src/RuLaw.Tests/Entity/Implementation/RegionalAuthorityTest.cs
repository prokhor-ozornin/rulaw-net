...
/// </summary>
public sealed class RegionalAuthorityTest : EntityTest<RegionalAuthority>
{
  /// <summary>
...
/// </summary>
public sealed class RegionalAuthorityInfoTests : EntityTest<RegionalAuthority.Info>
{
  /// <summary>
