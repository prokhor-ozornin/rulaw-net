...
/// </summary>
public sealed class RegionalAuthorityTest : UnitTest<RegionalAuthority>
{
  /// <summary>
...
/// </summary>
public sealed class RegionalAuthorityInfoTests : UnitTest<RegionalAuthority.Info>
{
  /// <summary>
  ...
  /// <summary>
  ///   <para>Performs testing of <see cref="RegionalAuthority.Info.Result()"/> method.</para>
  /// </summary>
  [Fact]
  public void Result_Method()
  {
    var result = new RegionalAuthority.Info().Result();
