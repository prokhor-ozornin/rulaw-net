...
/// </summary>
public sealed class LawTest : UnitTest<Law>
{
  /// <summary>
...
/// </summary>
public sealed class LawInfoTests : UnitTest<Law.Info>
{
  /// <summary>
  ...
  /// <summary>
  ///   <para>Performs testing of <see cref="Law.Info.Result()"/> method.</para>
  /// </summary>
  [Fact]
  public void Result_Method()
  {
    var result = new Law.Info().Result();
