...
/// </summary>
public sealed class LawBranchTest : UnitTest<LawBranch>
{
  /// <summary>
  ...
  /// </summary>
  [Fact]
  public void ToString_Method() { new LawBranch(new {Name = Guid.Empty.ToString()}).ToString().Should().Be(Guid.Empty.ToString()); }
}

/// <summary>
///   <para>Tests set for class <see cref="LawBranch.Info"/>.</para>
/// </summary>
public sealed class LawBranchInfoTests : UnitTest<LawBranch.Info>
{
  /// <summary>
  ...
  /// <summary>
  ///   <para>Performs testing of <see cref="LawBranch.Info.Result()"/> method.</para>
  /// </summary>
  [Fact]
  public void Result_Method()
  {
    var result = new LawBranch.Info().Result();
