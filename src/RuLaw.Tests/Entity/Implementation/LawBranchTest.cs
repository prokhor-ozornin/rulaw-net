...
public sealed class LawBranchTest : Test
{
  /// <summary>
  ...
  public void Serialization()
  {
    ...
    static void Test(ILawBranch branch) => branch.To<object>().Should().BeDataContractSerializable().And.BeXmlSerializable().And.BeJsonSerializable();
  }
}