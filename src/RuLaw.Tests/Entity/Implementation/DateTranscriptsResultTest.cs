...
/// </summary>
public sealed class DateTranscriptsResultTest : UnitTest<DateTranscriptsResult>
{
  /// <summary>
...
/// </summary>
public sealed class DateTranscriptsResultInfoTests : UnitTest<DateTranscriptsResult.Info>
{
  /// <summary>
  ...
  /// <summary>
  ///   <para>Performs testing of <see cref="DateTranscriptsResult.Info.Result()"/> method.</para>
  /// </summary>
  [Fact]
  public void Result_Method()
  {
    var result = new DateTranscriptsResult.Info().Result();
