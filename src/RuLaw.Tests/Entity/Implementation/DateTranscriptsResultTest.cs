...
/// </summary>
public sealed class DateTranscriptsResultTest : EntityTest<DateTranscriptsResult>
{
  /// <summary>
...
/// </summary>
public sealed class DateTranscriptsResultInfoTests : EntityTest<DateTranscriptsResult.Info>
{
  /// <summary>
