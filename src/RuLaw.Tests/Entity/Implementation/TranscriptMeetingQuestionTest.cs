...
/// </summary>
public sealed class TranscriptMeetingQuestionTest : EntityTest<TranscriptMeetingQuestion>
{
  /// <summary>
...
/// </summary>
public sealed class TranscriptMeetingQuestionInfoTests : EntityTest<TranscriptMeetingQuestion.Info>
{
  /// <summary>
