...
/// </summary>
public sealed class DeputyRequestAddresseeTest : UnitTest<DeputyRequestAddressee>
{
  /// <summary>
...
/// </summary>
public sealed class DeputyRequestAddresseeInfoTests : UnitTest<DeputyRequestAddressee.Info>
{
  /// <summary>
