...
/// </summary>
public sealed class DeputyRequestAddresseeTest : EntityTest<DeputyRequestAddressee>
{
  /// <summary>
...
/// </summary>
public sealed class DeputyRequestAddresseeInfoTests : EntityTest<DeputyRequestAddressee.Info>
{
  /// <summary>
