...
/// </summary>
public sealed class LawEventPhaseTest : UnitTest<LawEventPhase>
{
  /// <summary>
...
/// </summary>
public sealed class LawEventPhaseInfoTests : UnitTest<LawEventPhase.Info>
{
  /// <summary>
  ...
  /// <summary>
  ///   <para>Performs testing of <see cref="LawEventPhase.Info.Result()"/> method.</para>
  /// </summary>
  [Fact]
  public void Result_Method()
  {
    var result = new LawEventPhase.Info().Result();
