...
/// </summary>
public sealed class LawEventStageTest : UnitTest<LawEventStage>
{
  /// <summary>
  ...
  /// </summary>
  [Fact]
  public void ToString_Method() { new LawEventStage(new {Name = Guid.Empty.ToString()}).ToString().Should().Be(Guid.Empty.ToString()); }
}

/// <summary>
///   <para>Tests set for class <see cref="LawEventStage.Info"/>.</para>
/// </summary>
public sealed class LawEventStageInfoTests : UnitTest<LawEventStage.Info>
{
  /// <summary>
  ...
  /// <summary>
  ///   <para>Performs testing of <see cref="LawEventStage.Info.Result()"/> method.</para>
  /// </summary>
  [Fact]
  public void Result_Method()
  {
    var result = new LawEventStage.Info().Result();
