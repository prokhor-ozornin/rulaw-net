...
/// </summary>
public sealed class DeputyTranscriptsResultTest : UnitTest<DeputyTranscriptsResult>
{
  /// <summary>
...
/// </summary>
public sealed class DeputyTranscriptsResultInfoTests : UnitTest<DeputyTranscriptsResult.Info>
{
  /// <summary>
