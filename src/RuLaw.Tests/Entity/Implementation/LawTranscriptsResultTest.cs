...
/// </summary>
public sealed class LawTranscriptsResultTest : EntityTest<LawTranscriptsResult>
{
  /// <summary>
...
/// </summary>
public sealed class LawTranscriptsResultInfoTests : EntityTest<LawTranscriptsResult.Info>
{
  /// <summary>
