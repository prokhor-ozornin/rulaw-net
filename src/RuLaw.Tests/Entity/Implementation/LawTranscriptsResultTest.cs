...
/// </summary>
public sealed class LawTranscriptsResultTest : UnitTest<LawTranscriptsResult>
{
  /// <summary>
...
/// </summary>
public sealed class LawTranscriptsResultInfoTests : UnitTest<LawTranscriptsResult.Info>
{
  /// <summary>
