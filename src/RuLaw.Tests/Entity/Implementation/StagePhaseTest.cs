...
/// </summary>
public sealed class StagePhaseTest : UnitTest<StagePhase>
{
  /// <summary>
...
/// </summary>
public sealed class StagePhaseInfoTests : UnitTest<StagePhase.Info>
{
  /// <summary>
  ...
  /// <summary>
  ///   <para>Performs testing of <see cref="StagePhase.Info.Result()"/> method.</para>
  /// </summary>
  [Fact]
  public void Result_Method()
  {
    var result = new StagePhase.Info().Result();
