...
public sealed class StagePhaseTest : Test 
{
  /// <summary>
  ...
  public void Serialization()
  {
    ...
    static void Test(IStagePhase phase) => phase.To<object>().Should().BeDataContractSerializable().And.BeXmlSerializable().And.BeJsonSerializable();
  }
}