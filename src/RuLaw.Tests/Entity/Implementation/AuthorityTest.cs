...
/// </summary>
public sealed class AuthorityTest : UnitTest<Authority>
{
  /// <summary>
...
/// </summary>
public sealed class AuthorityInfoTests : UnitTest<Authority.Info>
{
  /// <summary>
  ...
  /// <summary>
  ///   <para>Performs testing of <see cref="Authority.Info.Result()"/> method.</para>
  /// </summary>
  [Fact]
  public void Result_Method()
  {
    var result = new Authority.Info().Result();
