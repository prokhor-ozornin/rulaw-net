...
/// </summary>
public sealed class VotesSearchResultTest : EntityTest<VotesSearchResult>
{
  /// <summary>
...
/// </summary>
public sealed class VotesSearchResultInfoTests : EntityTest<VotesSearchResult.Info>
{
  /// <summary>
