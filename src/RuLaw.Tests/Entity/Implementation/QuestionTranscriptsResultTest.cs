...
/// </summary>
public sealed class QuestionTranscriptsResultTest : EntityTest<QuestionTranscriptsResult>
{
  /// <summary>
...
/// </summary>
public sealed class QuestionTranscriptsResultInfoTests : EntityTest<QuestionTranscriptsResult.Info>
{
  /// <summary>
