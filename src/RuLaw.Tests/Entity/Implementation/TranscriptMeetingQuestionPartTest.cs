...
/// </summary>
public sealed class TranscriptMeetingQuestionPartTest : UnitTest<TranscriptMeetingQuestionPart>
{
  /// <summary>
...
/// </summary>
public sealed class TranscriptMeetingQuestionPartInfoTests : UnitTest<TranscriptMeetingQuestionPart.Info>
{
  /// <summary>
  ...
  /// <summary>
  ///   <para>Performs testing of <see cref="TranscriptMeetingQuestionPart.Info.Result()"/> method.</para>
  /// </summary>
  [Fact]
  public void Result_Method()
  {
    var result = new TranscriptMeetingQuestionPart.Info().Result();
