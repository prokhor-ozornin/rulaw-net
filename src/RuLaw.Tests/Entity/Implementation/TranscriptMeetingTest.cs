...
/// </summary>
public sealed class TranscriptMeetingTest : UnitTest<TranscriptMeeting>
{
  /// <summary>
...
/// </summary>
public sealed class TranscriptMeetingInfoTests : UnitTest<TranscriptMeeting.Info>
{
  /// <summary>
  ...
  /// <summary>
  ///   <para>Performs testing of <see cref="TranscriptMeeting.Info.Result()"/> method.</para>
  /// </summary>
  [Fact]
  public void Result_Method()
  {
    var result = new TranscriptMeeting.Info().Result();
